...
class Users_group_permissions(models.Model):

 user = models.ForeignKey(User, on_delete=models.CASCADE)
 group = models.ForeignKey(Group_permissions,on_delete=models.CASCADE ,db_column='group_id')

class Role_Group(models.Model):

 group = models.ForeignKey(Users_group_permissions,on_delete=models.CASCADE )
 permission = models.ForeignKey(Permissions,on_delete=models.CASCADE ,db_column='permission')